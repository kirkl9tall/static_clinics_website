    ...
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-3 gap-10 items-start">
            ...
            <div className="md:col-span-1 flex flex-col items-center">
              <div className="relative w-48 md:w-full max-w-[280px] aspect-[4/5] rounded-3xl overflow-hidden shadow-elevated bg-gradient-to-br from-primary-100 to-emerald-100 dark:from-primary-900/30 dark:to-emerald-900/30">
                ...
                <span className={`absolute bottom-3 left-1/2 -translate-x-1/2 px-4 py-1.5 text-xs font-semibold rounded-full border border-white/50 whitespace-nowrap ${avail.cls}`}>
                  {avail.label}
                </span>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                Book with {doctor.name.split(" ").at(-1)}
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-600 to-emerald-600 text-white">
        <div className="container-wide text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-3">Book an Appointment with {doctor.name}</h2>
          <p className="text-primary-100 mb-6">Schedule your consultation today.</p>
          <Link href={`/book-appointment?doctor=${doctor.slug}`} className="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-primary-700 font-semibold rounded-2xl hover:bg-primary-50 transition-all hover:shadow-xl">
